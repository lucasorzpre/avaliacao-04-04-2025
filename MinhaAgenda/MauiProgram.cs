...
namespace MinhaAgenda
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<IAdicionarObservacaoUseCase, AdicionarObsUseCase>();
            builder.Services.AddSingleton<IRepositorioObservacoes, RepositorioObservacaoSqlLite>();
            #endregion
            ...
            builder.Services.AddSingleton<AdicionarObsPage>();
